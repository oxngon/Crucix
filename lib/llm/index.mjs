...
import { TypesafeJevProvider } from "./typesafe.mjs";
...
export { TypesafeJevProvider } from "./typesafe.mjs";
...
export function createLLMProvider(llmConfig) {
  ...
  switch (provider.toLowerCase()) {
    ...
    case "openai":
      return new OpenAIProvider({ apiKey, model, baseUrl: llmConfig.baseUrl, apiKeyFile: llmConfig.apiKeyFile });
    case "openrouter":
    ...
    case 'typesafe':
      return new TypesafeJevProvider({ apiKey, model });
    default:
      console.warn(
